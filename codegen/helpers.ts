    ...
    Object.entries(data).map(
        ([key, obj]) =>
            ({
                ...
                showRealHair:
                    "ShowRealHair" in obj ? obj.ShowRealHair : undefined,
                skipHairstyleOffset:
                    "SkipHairstyleOffset" in obj
                        ? obj.SkipHairstyleOffset
                        : undefined,
                tilesheetSize:
                    "TilesheetSize" in obj ? obj.TilesheetSize : undefined,
                boundingBoxSize:
                    "BoundingBoxSize" in obj ? obj.BoundingBoxSize : undefined,
                rotations: "Rotations" in obj ? obj.Rotations : undefined,
                placementRestriction:
                    "PlacementRestriction" in obj
                        ? obj.PlacementRestriction
                        : undefined,
                defaultColor:
                    ("DefaultColor" in obj && obj.DefaultColor) || undefined,
                ...
                canBePlacedIndoors:
                    "CanBePlacedIndoors" in obj
                        ? obj.CanBePlacedIndoors
                        : undefined,
                canBePlacedOutdoors:
                    "CanBePlacedOutdoors" in obj
                        ? obj.CanBePlacedOutdoors
                        : undefined,
                ...
                areaOfEffect:
                    "AreaOfEffect" in obj ? obj.AreaOfEffect : undefined,
