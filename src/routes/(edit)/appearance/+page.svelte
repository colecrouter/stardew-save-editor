			...
			<div class="selector">
				<label>
					...
					<input
						...
						name="gender"
						value="male"
						checked={save.player && save.player.gender === Gender.Male}
						onclick={() => save.player && (save.player.gender = Gender.Male)}
					/>
				</label>
				<label>
					🚺
					<input
						...
						name="gender"
						value="female"
						checked={save.player && save.player.gender === Gender.Female}
						onclick={() => save.player && (save.player.gender = Gender.Female)}
					/>
				</label>
			</div>
