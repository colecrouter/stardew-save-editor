<script lang="ts">
    ...
    // Async load data
    let PrimarySkinColors: typeof import('$lib/CharacterColors').PrimarySkinColors = $state();
    let SecondarySkinColors: typeof import('$lib/CharacterColors').SecondarySkinColors = $state();
    let TertiarySkinColors: typeof import('$lib/CharacterColors').TertiarySkinColors = $state();

    let PrimaryBootColors: typeof import('$lib/CharacterColors').PrimaryBootColors = $state();
    let SecondaryBootColors: typeof import('$lib/CharacterColors').SecondaryBootColors = $state();
    let TertiaryBootColors: typeof import('$lib/CharacterColors').TertiaryBootColors = $state();
    let QuaternaryBootColors: typeof import('$lib/CharacterColors').QuaternaryBootColors = $state();
    ...
    let eyeTint: HairstyleColor = $state({ R: 0, G: 0, B: 0, A: 0, PackedValue: 0 });
    let bootsTint: [
        HairstyleColor,
        HairstyleColor,
        HairstyleColor,
...
<div class="appearance" class:female={gender === Gender.Female}>
    {#await loaded then}
        ...
        <div
            class="eyes"
            style:--spritesheet={`url(${base}/img/${otherSheet})`}></div>
        ...
        <div
            ...
            style:--x={'48px'}
            style:--y={'0'}
            style:--tint={`rgba(${bootsTint[0].R},${bootsTint[0].G},${bootsTint[0].B},${bootsTint[0].A})`}></div>
        <div
            class="boots"
            style:--spritesheet={`url(${base}/img/${bootsSheet})`}
            style:--x={'32px'}
            style:--y={'0'}
            style:--tint={`rgba(${bootsTint[1].R},${bootsTint[1].G},${bootsTint[1].B},${bootsTint[1].A})`}></div>
        <div
            class="boots"
            style:--spritesheet={`url(${base}/img/${bootsSheet})`}
            style:--x={'0px'}
            style:--y={'0'}
            style:--tint={`rgba(${bootsTint[2].R},${bootsTint[2].G},${bootsTint[2].B},${bootsTint[2].A})`}></div>
        <div
            class="boots"
            style:--spritesheet={`url(${base}/img/${bootsSheet})`}
            style:--x={'16px'}
            style:--y={'0'}
            style:--tint={`rgba(${bootsTint[3].R},${bootsTint[3].G},${bootsTint[3].B},${bootsTint[3].A})`}></div>
        <!-- END LAYERED TINT -->
        ...
        <div
            ...
            style:--tint={`rgba(${pantsTint.R},${pantsTint.G},${pantsTint.B},${pantsTint.A})`}></div>
        <div
            class="shirt"
            style:--spritesheet={`url(${base}/assets/${shirtSheet})`}
            style:--x={`${shirtPosition.x}px`}
            style:--y={`${shirtPosition.y}px`}
            style:--tint={`rgba(${shirtTint.R},${shirtTint.G},${shirtTint.B},${shirtTint.A})`}></div>
        ...
        {#if character?.accessory !== -1}
            ...
            <div
                ...
                style:--y={`${accessoryPosition.y}px`}></div>
            <!-- END LAYERED TINT -->
        {/if}
        ...
        {#if showHair}
            <div
                ...
                style:--tint={`rgba(${hairTint.R},${hairTint.G},${hairTint.B},${hairTint.A})`}></div>
        {/if}
